    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="border-b border-[#E8E5DE] bg-white">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="text-sm text-[#6B6B6B] mt-1">{filtered.length} products</p>
        </div>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Category pills with rounded-full styling */}
            ...
            {filtered.length > 0 && (
              <div className="flex justify-center items-center gap-1.5 mt-12">
                {[1, 2, 3].map(p => (
                  <button key={p} className={`w-8 h-8 text-xs font-medium rounded-lg transition-colors ${p === 1 ? 'bg-[#111111] text-white' : 'border border-[#E8E5DE] text-[#6B6B6B] hover:border-[#111111]'}`}>{p}</button>
                ))}
                <button className="w-8 h-8 text-xs text-[#6B6B6B] border border-[#E8E5DE] rounded-lg hover:border-[#111111]">›</button>
              </div>
            )}
          </div>
        </div>
