...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0B0C0E] flex flex-col items-center justify-center p-4 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl border border-[#E8E5DE] p-8 shadow-2xl space-y-6 relative z-10">
